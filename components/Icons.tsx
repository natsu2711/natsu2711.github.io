...
export const AvatarIcon: React.FC = () => (
    <svg width="64" height="64" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      ...
      <g filter="url(#shadow)">
        ...
        <path d="M25,80 Q50,95 75,80 Q50,90 25,80 Z" fill="#E74C3C" />
        <circle cx="50" cy="50" r="35" fill="url(#faceGradient)"/>
        <path d="M20,30 C30,10 70,10 80,30 C70,40 30,40 20,30 Z" fill="#2c3e50"/>
        <circle cx="38" cy="48" r="5" fill="#2c3e50"/>
        <circle cx="62" cy="48" r="5" fill="#2c3e50"/>
        <path d="M40,65 Q50,70 60,65" stroke="#2c3e50" strokeWidth="3" fill="none" strokeLinecap="round"/>
      </g>
    </svg>
);
